        ...
        <div className="hidden md:flex items-center space-x-4">
          ...
          {user ? (
            <>
              ...
              <Link to="/dashboard">
                <Button className="bg-linkedin hover:bg-linkedin-dark text-white rounded-full flex items-center gap-2">
                  <User size={16} />
                  {user.name || 'Account'}
                </Button>
              </Link>
            ...
            {user ? (
              <>
                ...
                <Link 
                  ...
                  onClick={() => setIsMenuOpen(false)}
                >
                  <Button className="w-full bg-linkedin hover:bg-linkedin-dark text-white flex items-center justify-center gap-2">
                    <User size={16} />
                    {user.name || 'Account'}
                  </Button>
                </Link>
